...
const getAllTickets = async (req, res) => {
    ...
    try {
        ...
        if (user_id) {
            getTicketsQuery += ` AND ((ta.assigned_to IS NULL AND ca.user_id = ${user_id}) OR ta.assigned_to = ${user_id} OR t.user_id = ${user_id}) OR ticket_status = 'Re-assign `;
            countQuery += ` AND ((ta.assigned_to IS NULL AND ca.user_id = ${user_id}) OR ta.assigned_to = ${user_id} OR t.user_id = ${user_id}) OR ticket_status = 'Re-assign`;
        }
